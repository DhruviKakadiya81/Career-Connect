                ...
                if(status == AuthenticationStatus.SUCCESS)
                    {
                        ...
                        if(ctx.isCallerInRole("Admin"))
                        {
                            ...
                            request.getRequestDispatcher("/DisplayCompany.xhtml").forward(req, res);
                        }
                       else if(ctx.isCallerInRole("User"))
                        {
                            request.setAttribute("user", ctx.getCallerPrincipal().getName());
                            request.getRequestDispatcher("/DisplayJob.xhtml").forward(req, res);
                        }
                    ...
                    else
                    {
                        ...
                        request.getRequestDispatcher("/Login.xhtml").forward(req, res);
